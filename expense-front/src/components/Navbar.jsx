        ...
        <div className="w-full h-16 bg-white">
            <div className="flex max-w-screen-xl justify-between mx-auto items-center h-16">
                <div className="flex gap-6 items-center">
                    <Geldii />
                    <button style={{ fontWeight: pathName === '/dashboard' ? '700' : '' }} onClick={dashboard}>Dashboard</button>
                    <button style={{ fontWeight: pathName === '/records' ? '700' : '' }} onClick={recording}>Records</button>
                </div>
